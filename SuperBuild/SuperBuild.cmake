...
option( BUILD_TESTING "Turn on Testing for MBWSS" ON )
...
file(WRITE "${CMAKE_CURRENT_BINARY_DIR}/MBWSS-build/CMakeCacheInit.txt" "${ep_common_cache}" )
...
ExternalProject_Add(${proj}
  ...
  BINARY_DIR MBWSS-build
  INSTALL_DIR ${CMAKE_INSTALL_PREFIX}
  CMAKE_GENERATOR ${gen}
  CMAKE_ARGS
    --no-warn-unused-cli
    -C "${CMAKE_CURRENT_BINARY_DIR}/MBWSS-build/CMakeCacheInit.txt"
    ${ep_common_args}
